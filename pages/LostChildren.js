...
export default function LostChildren() {
    ...
    <form className="d-flex"  role="search" style={{ backgroundColor: '#f0f0f0', padding: '8px',margin:'15px', borderRadius: '10px', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)' }}>
        ...
        <Link className="btn btn-outline-success" for="search" type="submit" to="/searchbyname" style={{ background: '#5cb85c', border: 'none', borderRadius: '5px', padding: '8px 15px' }}>Click here to Search</Link>
        <Link className="btn btn-primary.mx-2 " to="/adduser" >Add Children Detail</Link>
    </form>
</div>
